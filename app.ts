...
let person :{name:string, age:number,userId:string, hobbies:string[],role:[number,string,boolean,boolean,boolean]}={
    name : 'Harry',
    userId : 'ewrytrtyri',
    age : 37,
...
person.role.push("abc") // drawback of tuples we can used array methods on tuples it distrubed an array length
